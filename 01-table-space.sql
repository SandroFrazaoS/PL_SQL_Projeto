...
-- criando ambiente de teste chamado rp_mult_tst
-- entrar o XE, executar comandos abaixo
-- depois para criar uma conexao nova - nome tst  nome usuario user_tst ...
...
-- drop objetos  - nao precisa fazer so para conhecimento para eliminar os conteudos cado precisar
/*
